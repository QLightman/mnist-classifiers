    ...
    def __call__(self, input, kernel_size=None, stride=None):
        ...
        if self.layer_type == 'CONV':
            ...
            if not self.with_routing:
                ...
                assert input.get_shape() == [cfg.batch_size, 12, 12, 256]
                ...
                assert capsules[0].get_shape() == [cfg.batch_size, 128, 1, 1]
                ...
                assert capsules.get_shape() == [cfg.batch_size, 128, 8, 1]
                return(capsules)

        if self.layer_type == 'FC':
            if self.with_routing:
                # the DigitCaps layer, a fully connected layer
                # Reshape the input into [batch_size, 128, 1, 8, 1]
